...
class TvDetailScreen extends StatefulWidget {
  ...
  const TvDetailScreen({super.key, required this.tvSeries});
...
class _TvDetailScreenState extends State<TvDetailScreen>
  ...
  Future<void> _loadTvSeriesDetails() async {
    setState(() {
      _isLoading = true;
      _error = null;
    });
    ...
    try {
      final detailedTvSeries = await _api.getTvSeriesDetails(
        widget.tvSeries.id,
      );
      setState(() {
        _detailedTvSeries = detailedTvSeries;
        _error = null;
      });
  ...
  Widget build(BuildContext context) {
    final tvSeries = _detailedTvSeries ?? widget.tvSeries;
              ...
              Consumer<FavoritesProvider>(
                builder: (context, favoritesProvider, child) {
                  ...
                  return Container(
                    ...
                    child: IconButton(
                      onPressed: () async {
                        await favoritesProvider.toggleFavorite(tvSeries, 'tv');
                      },
                        ...
                        (context, url, error) => Container(
                          color:
                              isDark
                                  ...
                                  : Colors.grey[200],
                          child: const Icon(Icons.tv_rounded, size: 50),
                        ),
                  ),
                  Container(
                    decoration: BoxDecoration(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // TV Series info chips
                    _buildTvSeriesInfoChips(tvSeries),
                      ...
                      Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            ElevatedButton.icon(
                              onPressed: _loadTvSeriesDetails,
  ...
  Widget _buildTvSeriesInfoChips(TvSeries tvSeries) {
    final isDark = Theme.of(context).brightness == Brightness.dark;
    ...
    return Wrap(
      ...
      children: [
        ...
        _buildInfoChip(
          ...
          label: tvSeries.formattedRating,
          gradient: LinearGradient(
            colors: [
        ...
        // First air date
        if (tvSeries.firstAirDate != null && tvSeries.firstAirDate!.isNotEmpty)
          _buildInfoChip(
            icon: Icons.calendar_today_rounded,
            iconColor: const Color(0xFF00D4FF),
            label: _formatDate(tvSeries.firstAirDate!),
            gradient: LinearGradient(
              colors: [
        ...
        _buildInfoChip(
          ...
          label: '${tvSeries.voteCount} ${AppStrings.votes}',
          gradient: LinearGradient(
            colors: [
        ...
        _buildInfoChip(
          ...
          label: tvSeries.originalLanguage.toUpperCase(),
          gradient: LinearGradient(
            colors: [
